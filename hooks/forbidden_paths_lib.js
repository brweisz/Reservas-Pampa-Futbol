...
function buildForbiddenIndex(cwd, relativePaths) {
...
async function readToolArgsFromStdin() {
  const chunks = [];
...
module.exports = {
  ...
  compileGlobSegment,
  expandGlobToFilesystem,
  expandTildeIfPresent,
  substituteEnvVarsOrFail,
  expandTokenToCandidatePaths,
  tokenizeBashCommandIntoStatements,
  detectLinkCreationCommand,
  checkSymlinkSourceDoesNotReachForbidden,
